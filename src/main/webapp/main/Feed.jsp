...
<head>
    ...
    <script>
        $(function () {
            //初始化表单属性
            $("#vTable").jqGrid({
                url: "${path}/feed/all",  //分页查询   page  rows  total recoreds  page  rows
                ...
                colModel: [
                    ...
                    {
                        name: 'content', width: 100,height:400, align: "center",
                    },
                    {
                        name: 'user_id', editable: true, width: 100,align: "center",
                    },
                ]
            });
