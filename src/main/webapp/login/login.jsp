...
<script>
    $(function(){
        ...
        $("#captchaImage").click(function(){
            $("#captchaImage").prop("src","${path}/admain/code?d="+new Date().getTime());
        });
        //表单验证
        $.extend($.validator.messages,{
            required: "这是必填字段",//提示信息
            minlength: $.validator.format("最少字段长度为6")
        })
        $("#loginButtonId").click(function () {
            //表单验证
            var isOk=$("#loginButtonId").valid();
            if(isOk){
                $.ajax({
                   url:"${path}/admain/login" ,
                    type:"post",
            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${path}/admain/login" method="post" class="login-form" id="loginForm">
                            <span id="msgDiv"></span>
                            ...
                            <div class="form-group">
                                ...
                                <img id="captchaImage" style="height: 48px" class="captchaImage" src="${path}/admain/code">
